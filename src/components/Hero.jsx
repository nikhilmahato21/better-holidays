    ...
    <section id="home" className="relative h-screen min-h-[640px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 lg:px-20 max-w-7xl mx-auto">
        <AnimatePresence mode="wait">
          ...
          >
            <p className="font-outfit pt-10 text-3xl lg:text-3xl tracking-[0.25em] uppercase text-white/90 font-bold mb-2">
              Better Holidays Abroad
            </p>
            <p className="font-playfair italic text-gold text-xl lg:text-2xl mb-3 text-shadow-sm">
              {slide.subtitle}
            </p>
            <h1 className="font-playfair font-black text-white text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight text-shadow whitespace-pre-line mb-4">
              {slide.title}
            </h1>
            <div className="flex items-center gap-2 mb-8">
              <div className="w-8 h-0.5 bg-teal" />
              <p className="text-white/40 font-outfit text-[8px] tracking-widest uppercase">
                {slide.dest}
              </p>
            </div>
          </motion.div>
